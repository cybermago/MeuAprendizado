//cria e referencia ao form e aos elementos h3 e h4 (resposta)
...
frm.addEventListener("submit", (e) =>{
    const titulo = frm.inTitulo.value //obtem os conteudos dos campos
    const duracao = Number(frm.inDuracao.value)

    const horas = Math.floor(duracao / 60) //arredonda resultado para baixo
